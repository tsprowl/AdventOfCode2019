	...
	public static void main(String[] args) {
			...
			if (direction1.get(iterator1).contains("R")) {
				for (int i = 0; i < moveCounter; i++) {
					if (array[currentY][currentX+1] != null) {
						if (array[currentY][currentX+1] == 2) {
							array[currentY][currentX+1] = 3;
						}
					}
					else {
						array[currentY][currentX+1] = 1;
					}
					currentX = currentX+1;
				}
			}
			...
			if (direction1.get(iterator1).contains("D")) {
				for (int i = 0; i < moveCounter; i++) {
					if (array[currentY+1][currentX] != null) {
						if (array[currentY+1][currentX] == 2) {
							array[currentY+1][currentX] = 3;
						}
					}
					else {
						array[currentY+1][currentX] = 1;
					}
					currentY = currentY+1;
				}
			}
		...
		while (iterator2 < direction2.size()) {
			...
			if (direction2.get(iterator2).contains("R")) {
				for (int i = 0; i < moveCounter; i++) {
					if (array[currentY][currentX+1] != null) {
						if (array[currentY][currentX+1] == 1) {
							array[currentY][currentX+1] = 3;
						}
					}
					else {
						array[currentY][currentX+1] = 2;
					}
					currentX++;
				}
			}
			...
			if (direction2.get(iterator2).contains("D")) {
				for (int i = 0; i < moveCounter; i++) {
					if (array[currentY+1][currentX] != null) {
						if (array[currentY+1][currentX] == 1) {
							array[currentY+1][currentX] = 3;
						}
					}
					else {
						array[currentY+1][currentX] = 2;
					}
					currentY++;
				}
			}
		...
		for (int i = 0; i < 20000; i++) {
			for (int j = 0; j < 20000; j++) {
				if (array[i][j] != null) {
					if (array[i][j] == 3) {
						System.out.println(Math.abs(7000-j) + Math.abs(7000-i));
					}
				}
			}
		}
